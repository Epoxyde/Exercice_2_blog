...
class ArticleManager extends AbstractEntityManager 
{
     ...
     * et permet de trier les résultats.
     *
     * @param string $sort : critère de tri.
     * @param string $order : ordre ASC ou DESC.
     * @return array
     */
    public function getAllArticlesWithStats(
        string $sort = 'date',
        string $order = 'DESC'
    ) : array {
        $allowedSorts = [
        ...
        $sortColumn = $allowedSorts[$sort] ?? 'article.date_creation';
